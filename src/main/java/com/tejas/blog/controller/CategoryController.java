...
public class CategoryController {
	...
	@DeleteMapping("/{catId}")
	public ResponseEntity<ApisResponse> deleteCategory(@PathVariable Integer catId) {
		this.categoryService.deleteCategory(catId);
		return new ResponseEntity<ApisResponse>(new ApisResponse("category is deleted successfully !!", true),
				HttpStatus.OK);
	}
	// get
